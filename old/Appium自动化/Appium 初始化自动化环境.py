...
des = {
  ...
  "deviceName": 'xie wei jia',  # 设备名，安卓手机可以随意填写，IOS根据具体手机填写
  "appPackage": "uni.UNIE7FC6F0",  # cmd命令【adb shell am monitor】
  "appActivity": ".view.logo.SplashActivity", # cmd命令【adb shell dumpsys activity recents | find “intent={”】
