...
def Get_Device_Name():
    try:
        ...
        if Device_Name == Bl_de:  #判断Device_Name是否通过
           logger.info('Device_Name: ' + Device_Name ) #测试通过
        else:
...
def Get_Manufacture_Name_String():
    try:
        ...
        if Device_Name == Manufacturer:  #判断Device_Name是否通过
           logger.info('Device_Information: ' + Device_Name ) #测试通过
        else:
           logger.info('Device_Information: ' + Device_Name ) #测试失败
...
def Get_Model_Number_String():
    try:
        ...
        if Device_Name == Model:  #判断Device_Name是否通过
           logger.info('Model_Number_String: ' + Device_Name) #测试通过
        else:
